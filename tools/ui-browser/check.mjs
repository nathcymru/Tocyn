...
try{
 ...
 for(const style of ['default','radical','none']){
  ...
  try{
   ...
   assert.equal(external,0);results.push({style,behavior:'passed',checks:['native form serialization','event cancellation','busy state','confirmation focus/recovery','manual tabs','listbox selection','combobox selection/focus settlement','splitter keyboard resize and Home/End bounds','popover dismissal'],presentation,sizes});
