    ...
    extend: {
      semanticTokens: {
        colors: {
          ...
          'icon.primary': { value: '{colors.gray.12}' },
          'icon.muted': { value: '{colors.gray.11}' },
          'icon.disabled': { value: '{colors.gray.9}' },
          'icon.selected': { value: '{colors.blue.11}' },
          'icon.critical': { value: '{colors.red.11}' },
          'icon.inverse': { value: '{colors.gray.solid.fg}' },
      ...
      slotRecipes: {
        ...
        globalSearch: {
          ...
          base: {
            root: { position: 'relative', display: 'flex', flex: '1', minWidth: 'min(18rem, 100%)', width: '100%', maxWidth: '32rem', marginInline: 'auto', alignItems: 'center', border: '1px solid', borderColor: 'border.input', borderRadius: 'l2', background: 'bg.input', color: 'text.primary' },
        ...
        shell: {
          ...
          base: {
            ...
            navigationIcon: { flexShrink: '0', width: '2.5rem', height: '2.5rem', color: 'currentColor' },
            ...
            personaStatus: { position: 'absolute', insetBlockEnd: '-0.125rem', insetInlineEnd: '-0.125rem', width: '0.75rem', height: '0.75rem', borderRadius: 'full', borderWidth: '2px', borderColor: 'bg.surface', background: 'icon.selected' },
