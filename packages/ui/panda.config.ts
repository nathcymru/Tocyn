      ...
      slotRecipes: {
        ...
        page: {
          ...
          base: {
            ...
            inboxControls: { display: 'flex', minWidth: '0', flexWrap: 'wrap', alignItems: 'end', gap: '0.5rem' },
            inboxControlCell: { display: 'grid', minWidth: '8rem', flex: '1 1 9rem', gap: '0.25rem' },
