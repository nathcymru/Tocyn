      ...
      slotRecipes: {
        ...
        page: {
          ...
          base: {
            ...
            inboxDetail: { display: 'flex', minWidth: '0', minHeight: '0', flex: '1', flexDirection: 'column', overflow: 'hidden', background: 'bg.canvas' },
            inboxHeader: { display: 'grid', gap: '0.75rem', padding: { base: '0.875rem', md: '1rem 1.25rem 0.875rem' }, borderBottom: '1px solid', borderColor: 'border.default', background: 'bg.surface' },
            inboxControls: { display: 'grid', gridTemplateColumns: { base: '1fr', sm: 'repeat(2, minmax(0, 1fr))', lg: 'repeat(3, minmax(0, 1fr))' }, gap: '0.5rem' },
          ...
          compoundVariants: [
            ...
            { kind: 'inbox', css: { inboxControls: { gridTemplateColumns: { base: '1fr', sm: 'repeat(2, minmax(0, 1fr))', lg: 'repeat(3, minmax(0, 1fr))' } } } },
          ],
        ...
        ticketDetail: {
          ...
          base: {
            ...
            main: { display: 'flex', minWidth: '0', minHeight: '0', minInlineSize: '0', flexDirection: 'column', gap: '0.5rem', overflow: 'hidden', padding: { base: '0.5rem', md: '0.75rem' } },
            ...
            card: { display: 'flex', minWidth: '0', minHeight: '0', flex: '1', flexDirection: 'column', overflow: 'hidden', border: '1px solid', borderColor: 'border.default', borderRadius: 'l3', background: 'bg.surface', boxShadow: 'xs' },
