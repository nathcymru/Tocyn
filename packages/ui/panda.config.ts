      ...
      slotRecipes: {
        ...
        shell: {
          ...
          base: {
            ...
            pageTitle: { display: 'block', minWidth: '0', maxWidth: { base: '8rem', sm: '14rem', lg: '18rem' }, flexShrink: '0', margin: '0', overflow: 'hidden', color: 'text.primary', fontSize: '1rem', fontWeight: '700', lineHeight: '1.25', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
