      ...
      slotRecipes: {
        ...
        page: {
          ...
          base: {
            ...
            inboxHeader: { display: 'grid', flexShrink: '0', gap: '0.75rem', padding: { base: '0.875rem', md: '1rem 1.25rem 0.875rem' }, borderBottom: '1px solid', borderColor: 'border.default', background: 'bg.surface' },
            ...
            inboxMetrics: { display: 'grid', gridTemplateColumns: { base: 'repeat(2, minmax(0, 1fr))', lg: 'repeat(4, minmax(0, 1fr))' }, gap: '0.5rem' },
            ...
            inboxToolbar: { display: 'flex', minWidth: '0', alignItems: 'center', justifyContent: 'space-between', gap: '0.75rem', padding: '0.5rem 1.25rem', borderBottom: '1px solid', borderColor: 'border.default' },
