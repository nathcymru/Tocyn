      ...
      slotRecipes: {
        ...
        page: {
          ...
          base: {
            ...
            inboxControls: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(12rem, 1fr))', gap: '0.5rem', alignItems: 'end' },
          ...
          compoundVariants: [
            ...
            { kind: 'inbox', css: { inboxControls: { gridTemplateColumns: 'repeat(auto-fit, minmax(12rem, 1fr))' } } },
          ],
