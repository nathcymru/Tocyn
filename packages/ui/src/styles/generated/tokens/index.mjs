const tokens = {
  ...
  "sizes.target": {
    "value": "var(--tocyn-target-min, 44px)",
    "variable": "var(--sizes-target)"
  },
  "sizes.breakpoint-sm": {
    "value": "640px",
  ...
  "colors.selected": {
    "value": "var(--colors-selected)",
    "variable": "var(--colors-selected)"
  },
  "colors.divider": {
    "value": "var(--colors-divider)",
    "variable": "var(--colors-divider)"
  },
  "colors.critical": {
    "value": "var(--colors-critical)",
