/* eslint-disable */
export type Token = `aspectRatios.${AspectRatioToken}` | `borders.${BorderToken}` | `easings.${EasingToken}` | `durations.${DurationToken}` | `fontWeights.${FontWeightToken}` | `lineHeights.${LineHeightToken}` | `letterSpacings.${LetterSpacingToken}` | `fontSizes.${FontSizeToken}` | `shadows.${ShadowToken}` | `colors.${ColorToken}` | `blurs.${BlurToken}` | `spacing.${SpacingToken}` | `animations.${AnimationToken}` | `fonts.${FontToken}` | `radii.${RadiusToken}` | `sizes.${SizeToken}` | `breakpoints.${BreakpointToken}`

export type ColorPalette = "current" | "black" | "white" | "transparent" | "rose" | "pink" | "fuchsia" | "purple" | "violet" | "indigo" | "blue" | "sky" | "cyan" | "teal" | "emerald" | "green" | "lime" | "yellow" | "amber" | "orange" | "red" | "neutral" | "stone" | "zinc" | "gray" | "slate" | "bg.canvas" | "bg.surface" | "bg.input" | "text.primary" | "text.muted" | "border.input" | "border.focus" | "accent.primary" | "canvas" | "panel" | "muted" | "text" | "textMuted" | "focus" | "selected" | "divider" | "critical" | "bg.default" | "bg.subtle" | "fg.default" | "fg.muted" | "border.default"
