/* eslint-disable */
export type Token = `aspectRatios.${AspectRatioToken}` | `borders.${BorderToken}` | `easings.${EasingToken}` | `durations.${DurationToken}` | `fontWeights.${FontWeightToken}` | `lineHeights.${LineHeightToken}` | `fonts.${FontToken}` | `letterSpacings.${LetterSpacingToken}` | `fontSizes.${FontSizeToken}` | `shadows.${ShadowToken}` | `colors.${ColorToken}` | `blurs.${BlurToken}` | `spacing.${SpacingToken}` | `animations.${AnimationToken}` | `radii.${RadiusToken}` | `sizes.${SizeToken}` | `breakpoints.${BreakpointToken}`

export type ColorPalette = "current" | "black" | "white" | "transparent" | "rose" | "pink" | "fuchsia" | "purple" | "violet" | "indigo" | "blue" | "sky" | "cyan" | "teal" | "emerald" | "green" | "lime" | "yellow" | "amber" | "orange" | "red" | "neutral" | "stone" | "zinc" | "gray" | "slate" | "canvas" | "panel" | "muted" | "text" | "textMuted" | "focus" | "selected" | "divider" | "critical" | "bg.canvas" | "bg.default" | "bg.subtle" | "fg.default" | "fg.muted" | "border.default"
...
export type RadiusToken = "xs" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "4xl" | "full" | "control" | "panel"
