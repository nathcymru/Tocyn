## Combined provider/knowledge integration — 11 September 2026

PR #213 now incorporates frozen #214 cebe0bad8d258471a3dfddf3b4ab8dd8e42dd42a alongside #215 categories. This groups the reviewed resource and uncertain-effect corrections into one backend acceptance batch. Combined native28/28 and combined runtime types passed with migrations0061/0064; all three suites remain in required CI. Only shared CI/package test-list conflicts occurred and all commands were retained. Exact current CI, signed accepted integration and issue receipts are still pending. #214/#215 must not merge independently.
