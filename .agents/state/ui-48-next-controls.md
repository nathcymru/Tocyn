...
Checkpoint10September19:08BST: security profile and email add/provider controls implemented with focused synthetic recovery coverage, still awaiting full browser/VoiceOver/performance acceptance. Knowledge marker compatibility requires the pending owner clarification recorded in ui-48.md. Current accepted main remains6299bfef; partial drafts are not accepted beta features.
