...
2. Run `node tools/agent-context/index.mjs query CustomerAuthService` (replace the symbol).
...
The graph contains identifiers, source locations and import edges, not a call graph or
...
add an LLM indexing service, or include development tooling in application bundles.
