...
5. [Current remaining-work forecast and sprint](reforecast-2026-09-11.md), [agent handover and next tasks](handover.md)
...
Current accepted foundations include canonical conversations, scoped storage, authenticated local beta operation, permissions #79, themes #66, composer #68, 48-hour durable drafts #129, full SLA #73, waiting-state #136 and partial collaboration #70. Accepted main70b75aba (PR #205) extends budget enforcement across workspace, administration, knowledge reads and retention. Full #64 coverage and strict combined-profile evidence remain outstanding, as do the coherent persistent inbox, queues and the complete #140 operator gate. Queue pipeline and later governed actions remain planned; #80/#81 are not implemented merely because an ADR is accepted. Existing primitives and SettingsLayout are reused.
