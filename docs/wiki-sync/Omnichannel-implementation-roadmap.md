...
Authentication/transactional mail and support-email conversations are separate capabilities (ADR-0013). Cloudflare-native authentication-mail migration is not automatically a prerequisite for the support-email channel.
