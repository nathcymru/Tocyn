...
Workspace drafts, attention state, linked work, feedback and contextual assistance remain subject to this boundary: metadata, presentation state and operator feedback never grant tenant access. Their planned storage and retention treatment is described in [ADR-0018](https://github.com/nathcymru/Tocyn/blob/main/docs/adr/ADR-0018-durable-operator-attention-and-continuity.md), [ADR-0022](https://github.com/nathcymru/Tocyn/blob/main/docs/adr/ADR-0022-data-residency-and-storage-boundaries.md) and [ADR-0026](https://github.com/nathcymru/Tocyn/blob/main/docs/adr/ADR-0026-access-identity-and-permission-boundaries.md). This is implementation pending.
