...
The post-beta direction keeps authentication mail separate from support-email conversations. The historical local beta used local mail capture; no external beta mail delivery is required for the next workspace gate. See [ADR-0016](https://github.com/nathcymru/Tocyn/blob/main/docs/adr/ADR-0016-product-boundary-and-release-gates.md) and [ADR-0027](https://github.com/nathcymru/Tocyn/blob/main/docs/adr/ADR-0027-linked-work-and-workflow-continuity.md). This is implementation pending.
