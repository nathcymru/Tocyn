...
export const CUSTOMER_AUTH_ENVELOPES: Readonly<Record<CustomerAuthOperation, Readonly<ResourceAmounts>>> = Object.freeze({
  // Includes the bounded post-commit D1 allocation-evidence update. It is
  // operational overhead, never an estimate of physical storage growth.
  request: Object.freeze({ workerRequests: 1, d1RowsRead: 3_072, d1RowsWritten: 40, doRequests: 8, doRowsRead: 8, doRowsWritten: 8, logEvents: 67 }),
