...
import type { TicketListScanSnapshot } from './ticket-list-scan.repository';
...
export interface TicketRepository {
  ...
  delete(id: string): Promise<void>;
  findCustomerTickets(customerEmail: string, page: number, limit: number, scanFence?: TicketListScanSnapshot): Promise<{ data: Ticket[], total: number }>;
