...
export function replyCapability(ticketId: string, collision?: ReplyCapabilityV1['collision'], internalMentions?: ReplyCapabilityV1['internalMentions']): ReplyCapabilityV1 {
  return {
    version: 1,
    ticketId,
    ...(collision ? { collision } : {}),
