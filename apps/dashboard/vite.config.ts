      ...
      output: {
        ...
        codeSplitting: {
          groups: [
            ...
            { name: 'administration-routes', test: /\/apps\/dashboard\/src\/pages\/(?:ApiKey|AgentPermissions|FiltersSettings|Groups|Settings|SlaSettings|SupportStates|TicketFields|Users)Page\.tsx$/, priority: 0 },
          ],
        },
      },
    },
