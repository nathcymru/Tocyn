...
export function SupportStatesPage() {
  ...
  return <div className="max-w-4xl space-y-6">
    ...
    {error && states.length === 0 && <div role="alert"><TocynEmptyState
      title="Could not load support states."
      description="The definitions are unavailable. Retry before editing support-state configuration."
      action={<TocynButton type="button" onClick={() => void refetch()}>Retry loading support states</TocynButton>}
    /></div>}
